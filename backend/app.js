...
// SCRUM-210: Vibe Search route — POST /api/vibe-search (Gemini-powered)
const vibeSearchRouter = require("./routes/vibeSearch");
app.use("/api/vibe-search", vibeSearchRouter);
